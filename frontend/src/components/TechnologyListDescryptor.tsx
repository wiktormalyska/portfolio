import {SimpleIcon, siReact, siTypescript} from "simple-icons";
...
export const GetListOfIconsFromTechnologyList = ({technologiesString}: GetListOfIconsFromTechnologyListProps): ReactNode[] => {
    return technologiesString.map(technologyString => {
        ...
        return (
            <div className="flex flex-row gap-3 justify-center items-center p-2 pl-4 pr-4 bg-neutral-900 rounded-full">
