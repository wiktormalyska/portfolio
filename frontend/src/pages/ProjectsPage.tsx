            ...
            <span
                ...
                <div className="flex flex-row max-2xl:flex-col gap-10 pt-10">
                    {projects!.map(project => {
                        return (
                            <a key={project.gitHubRepositoryId} href={project.repositoryUrl} target="_blank"
                               className="w-[50%] max-2xl:w-full ">
                                <div className="relative flex flex-col w-full p-2 h-full">
                                    ...
                                    <img className="w-full rounded-2xl object-cover object-top min-h-50 max-h-100 z-40"
